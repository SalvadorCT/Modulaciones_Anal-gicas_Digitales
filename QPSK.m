...
t = 0:1/fs:0.05; % Vector de tiempo
...
figure('Name', 'Modulación QPSK en el dominio del tiempo')
subplot(3, 1, 1);
plot(t, m_I, 'b');
...
figure('Name', 'Espectro de frecuencia QPSK')
plot(f, 2 * abs(Y(1:N/2+1)), 'b', 'linewidth', 1.5);
title('Espectro de frecuencia QPSK');
